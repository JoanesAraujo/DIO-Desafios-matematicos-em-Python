...
while n:
    ...
    placa = input().split('-')
		...
		# isalpha () para detectar a seqüência consiste de apenas letras.
		# IsNumeric () método para detectar uma cadeia que consiste apenas números.
		# len() retorna a quantidade de elementos de qualquer lista em Python
